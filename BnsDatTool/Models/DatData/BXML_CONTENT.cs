...
namespace Xylia.bns.Modules.DataFormat.Dat
{
	public class BXML_CONTENT
	{
		...
		public BXML_CONTENT(byte[] XorKey) => this.XOR_KEY = XorKey;
		#endregion
		...
		public void Read(Stream iStream, BXML_TYPE iType)
		{
			...
			else if (iType == BXML_TYPE.BXML_BINARY)
			{
				...
				this.Padding = br.ReadBytes(64);
				this.Unknown = br.ReadByte() == 1;
				this.OriginalPath = ReadText(br);
				this.AutoID = 1;
				this.ReadNode(iStream);
